...
$query = "SELECT incomestatus,first_name, email FROM registered WHERE user_id = ?";
...
if ($result->num_rows > 0) {
    ...
    $yearly_income = $user_data['incomestatus'];
...
if (is_numeric($yearly_income) && $yearly_income > 0) {
    $monthly_income = $yearly_income / 12;
    $monthly_income = number_format($monthly_income, 2);
} else {
    $monthly_income = '0.00'; // Default to 0 if income is not valid
}
...
$stmt2->bind_param("iii", $user_id, $user_id, $user_id); // Bind the user_id 3 times for each subquery
$stmt2->execute();
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" dashboard2.php " target="_blank">
        <img src="./assets/img/Ease-modified.png" class="navbar-brand-img h-100" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      ...
      <li class="nav-item">
          <div class="ps-4 ms-2">
              <p class="text-sm mb-0" style="color: black; font-weight: bold;">Name: <?php echo htmlspecialchars($first_name); ?></p>
              <p class="text-sm mb-0" style="color: black; font-weight: bold;">Email: <?php echo htmlspecialchars($email); ?></p>
          </div>
      </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link " href="ForIncome.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-calendar-grid-58 text-warning text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Income pay</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="ForLand.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-credit-card text-success text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Land pay</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="ForVehicle.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-app text-info text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Vehicle pay</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="businessdashboard.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-credit-card text-success text-sm opacity-10"></i>
            </div>
      ...
      <li class="nav-item">
        <a class="nav-link" href="taxappeal.php">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            
            <i class="ni ni-money-coins text-info text-sm opacity-10"></i>
          </div>
          <span class="nav-link-text ms-1">Tax Appeal</span> 
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="generate_pdf_report.php">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <li class="nav-item">
          <a class="nav-link" href="asset_details.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <main class="main-content position-relative border-radius-lg ">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-white font-weight-bold px-0">
                ...
                <span class="d-sm-inline d-none"><?php echo htmlspecialchars($first_name); ?></span>
              </a>
            </li>
            ...
            <li class="nav-item d-flex align-items-center" style="margin-left: 20px;"> <!-- Added margin here -->
                <a href="business.php" class="nav-link text-white font-weight-bold px-0">
                    <span class="ms-1 d-sm-inline d-none">Business</span>
                </a>
            </li>
    ...
    <div class="container-fluid py-4">
              ...
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <?php echo htmlspecialchars($monthly_income); ?>
                    </h5>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <h5 class="font-weight-bolder"> TK
                    <?php echo htmlspecialchars($yearly_income); ?>
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Due Tax</p>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Paid Till Today</p>
                    <h5 class="font-weight-bolder"> TK
                    <?php echo htmlspecialchars($total_paid); ?>
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
          ...
          <div class="card card-carousel overflow-hidden h-100 p-0">
            <div id="carouselExampleCaptions" class="carousel slide h-100" data-bs-ride="carousel">
              <div class="carousel-inner border-radius-lg h-100">
                <div class="carousel-item h-100 active" style="background-image: url('./assets/img/safe.jpg');
      background-size: cover;">
                ...
                <div class="carousel-item h-100" style="background-image: url('./assets/img/tom.jpg');
      background-size: cover;">
                  <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                    <div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
                      <i class="ni ni-bulb-61 text-dark opacity-10"></i>
                    </div>
                    <h5 class="text-white mb-1">Feeling lost?</h5>
                    <p>Use our very own 'EaseBot' to help yourself out! Click on handsome face, down right below!</p>
                  </div>
                </div>
                <div class="carousel-item h-100" style="background-image: url('./assets/img/taX.jpg');
      background-size: cover;">
                  <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                    <div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
      ...
      <div class="row mt-4">
          ...
          <div class="card ">
            ...
            <div class="table-responsive">
              <table class="table align-items-center ">
                ...
                $query = "
                    SELECT 'Income Tax' AS payment_purpose, paying_amount,paying_gateway, paying_date 
                    FROM payment_incometax 
                    WHERE user_id = '$user_id'
                    
                    UNION ALL
                    
                    SELECT 'Land' AS payment_purpose, paying_amount,paying_gateway, paying_date 
                    FROM payment_land 
                    WHERE user_id = '$user_id'
                    
                    UNION ALL
                    
                    SELECT 'Vehicle' AS payment_purpose, paying_amount,paying_gateway, paying_date 
                    FROM payment_vehicle 
                    WHERE user_id = '$user_id'
                ";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo '<thead><tr><th>Payment Purpose</th><th>Paying Amount</th><th>Paying Gateway</th><th>Payment Date</th></tr></thead>';
                    echo '<tbody>';
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<td>' . htmlspecialchars($row['paying_gateway']) . '</td>';
        ...
        <div class="col-lg-7 mb-lg-0 mb-4">
          <div class="card ">
            <div class="card-header pb-0 p-3">
              <div class="d-flex justify-content-between">
                <h6 class="mb-2">Tax Appeal History</h6>
              </div>
            </div>
            <div class="table-responsive">
              <table class="table align-items-center ">
                ...
                // Query to fetch payment history from all three tables
                $query = "
                    SELECT appeal_date, appeal_text, statuss 
                    FROM appeal
                    WHERE user_id = '$user_id'
                ";
                ...
                if ($result->num_rows > 0) {
                    echo '<table class="table align-items-center text-center">';
                    echo '<thead><tr><th>Date</th><th>Appeal Text</th><th>Status</th></tr></thead>';
                    echo '<tbody>';
    ...
    <div class="card">
        ...
        <div class="d-flex justify-content-center align-items-center" style="height: 200px;"> <!-- Centering container -->
            <a href="Calculator.php" class="btn btn-black">Calculate Your Income Tax</a>
        </div>
    </div>  
</div>
